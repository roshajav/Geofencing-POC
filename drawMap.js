...
var polygonData = JSON.parse(localStorage.getItem("polygonData")) || [
  [
    { lat: 12.994007, lng: 77.705056 },
    { lat: 12.993286, lng: 77.705089 },
    { lat: 12.993192, lng: 77.705947 },
    { lat: 12.994049, lng: 77.705829 },
  ],
  [
  ...
  [
    { lat: 12.99058, lng: 77.710867 },
    { lat: 12.987485, lng: 77.710867 },
    { lat: 12.990161, lng: 77.716403 },
  ],
];
var coordinates = [];
let new_coordinates = [];
...
function savePolygonDataToLocalStorage() {
